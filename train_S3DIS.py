...
if __name__ == '__main__':
    ...
    parser.add_argument('--devices', default='0')# Initialize the environment
    ...
    training_dataset = S3DISDataset(config, set='training', use_potentials=True, tranform=transform)
