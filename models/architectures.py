...
class KPCNN(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.head_softmax = UnaryBlock(1024+128, config.num_classes, False, 0)
        ################
        # Network Losses
        ################
        ...
        self.reg_loss = 0
        self.l1 = nn.L1Loss()
        self.spherical_features = SphericalCNN(out_channels=128)
        #self.spherical_mlp = UnaryBlock(1024, 128, False, 0)
    ...
    def forward(self, batch, config):
        ...
        #useless spherical_features = self.spherical_mlp(spherical_features)
        #useless spherical_features = spherical_features.repeat(points_num, 1)
        ...
        #useless point_features = [array.unsqueeze(0) for array in point_features]
        point_features = torch.cat(point_features, dim=0)
        #useless point_features = self.point_mlp(point_features)
