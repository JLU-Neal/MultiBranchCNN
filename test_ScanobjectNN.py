...
if __name__ == '__main__':
    ...
    previous_training_path = 'Log_2020-10-25_04-21-07'
    ...
    if previous_training_path:
        ...
        chkp_path = os.path.join('/data/tzf/KPCOnv-PyTorch-master/results', previous_training_path, 'checkpoints')
    ...
    if previous_training_path:
        config.load(os.path.join('/data/tzf/KPCOnv-PyTorch-master/results', previous_training_path))
    ...
    _file = 'libmatrix.so'
    _path = '/data/tzf/KPCOnv-PyTorch-master/models/' + _file
    ...
    try:
        ...
        trainer.validation(net, val_loader=test_loader, config=config)
    except:
