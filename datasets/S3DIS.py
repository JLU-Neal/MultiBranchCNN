...
class S3DISDataset(PointCloudDataset):
    ...
    def __init__(self, config, set='training', use_potentials=True, load_data=True, tranform=None):
        """
    ...
    def __getitem__(self, batch_i):
        ...
        if self.use_potentials:
            data = self.potential_item(batch_i)
        else:
            data = self.random_item(batch_i)
        if self.transform:
            L = (len(data) - 7) // 5
            transformed_data = self.transform(data[0], data[4 * L])
...
class S3DISCustomBatch:
    ...
    def __init__(self, input_list):
        ...
        # self.transformed_data = self.transformed_data.to(torch_device)
        # Get rid of batch dimension
        input_list = input_list[0]
        # input_list = input_list[0]#since I added transformed_data I
        # Number of layers
    ...
    def to(self, device):
        ...
        self.transformed_data = self.transformed_data.cuda()
