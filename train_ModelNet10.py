...
from datasets.ModelNet10 import *
...
if __name__ == '__main__':
    ...
    # Initialize datasets
    training_dataset = ModelNet40Dataset(config, train=True, tranform=transform)
    ...
    test_sampler = ModelNet40Sampler(test_dataset, balance_labels=False)
