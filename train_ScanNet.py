...
if __name__ == '__main__':
    ...
    # Initialize datasets
    training_dataset = ScanNetDataset(config, train=True, spherical_transform=transform)
    test_dataset = ScanNetDataset(config, train=False, spherical_transform=transform)

    # Initialize samplers
    training_sampler = ScanNetSampler(training_dataset, balance_labels=True)
    test_sampler = ScanNetSampler(test_dataset, balance_labels=False)
