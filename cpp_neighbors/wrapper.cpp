...
static PyObject* batch_neighbors(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	voxel_index_neighbors(queries, supports, q_batches, s_batches, neighbors_indices, radius);
	//hash_index_neighbors(queries, supports, q_batches, s_batches, neighbors_indices, radius);
	// Check result
